...
class TestAmity(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_create_single_room = self.test_amity.create_room({"<room_name>":["OCULUS"]},"O")
    ...
    def test_adding_rooms_twice(self):
        ...
        self.adding_rooms_twice = self.test_amity.create_room({"<room_name>":["HOGWARTS"]}, "O")
        self.assertIn("HOGWARTS Exists\n", self.adding_rooms_twice, msg ="Room added twice")
