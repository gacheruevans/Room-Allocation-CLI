...
class TestAmity(unittest.TestCase):
    ...
    def test_getting_persons_name_from_people_data(self):
        ...
        self.get_name = self.test_amity.get_names(1)
        self.get_name_with_wrong_id = self.test_amity.get_names(8)
    ...
    def test_print_room(self):
        # Test print rooms
        self.printing_non_existent_room = self.test_amity.print_room(
            {"<room_name>": "LONGONOT"})
        self.assertEqual(self.printing_non_existent_room,
                         "LONGONOT Room Does Not Exist")
        self.printing_existent_room = self.test_amity.print_room(
            {"<room_name>": "PYTHON"})
        self.assertNotEqual(self.printing_existent_room,
                            "", msg="Room Does Not Exist")
        self.printing_empty_room = self.test_amity.print_room(
            {"<room_name>": "GO"})
